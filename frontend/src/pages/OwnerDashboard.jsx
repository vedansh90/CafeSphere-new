...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    const fetchCafeDetails = async () => {
      try {
        const response = await axios.get(`http://192.168.1.3:4000/owner/owner-dashboard/${id}`);
  ...
  useEffect(() => {
    ...
    const fetchCafeMenu = async () => {
      try {
        const response = await axios.get(`http://192.168.1.3:4000/owner/owner-dashboard/${id}/menu`);
  ...
  const handleConfirmBooking = async (id) => {
    console.log(id);
    try{
      const res = await axios.post('http://192.168.1.3:4000/owner/owner-dashboard/confirm-booking', {
        id,
      });
  ...
  const handleRejectBooking = async (id) => {
    console.log(id);
    try{
      const res = await axios.post('http://192.168.1.3:4000/owner/owner-dashboard/reject-booking', {
        id,
      });
  ...
  try {
    const response = await axios.post("http://192.168.1.3:4000/owner/owner-dashboard/verify-token", {
